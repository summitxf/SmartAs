...
(function($) {
    ...
    function _24(_25) {
        ...
        _2c.add(_2d).children("div.datagrid-body").css({
            marginTop: _33,
            height: (isNaN(parseInt(_27.height)) ? "" : (_2a - _34)),
    ...
    function _51(datagrid, _53) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _5a,
                view2: _5b,
                header1: _5a.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _5b.children("div.datagrid-header").children("div.datagrid-header-inner"),
                body1: _5a.children("div.datagrid-body").children("div.datagrid-body-inner"),
                body2: _5b.children("div.datagrid-body"),
                footer1: _5a.children("div.datagrid-footer").children("div.datagrid-footer-inner"),
                footer2: _5b.children("div.datagrid-footer").children("div.datagrid-footer-inner")
            }
        };
    };
    ...
    function _5c(_5d) {
        ...
        if (_5f.pagination) {
            ...
            _66.pagination({
                total: (_5f.pageNumber * _5f.pageSize),
                pageNumber: _5f.pageNumber,
                pageSize: _5f.pageSize,
                pageList: _5f.pageList,
                onSelectPage: function(_68, _69) {
                    _5f.pageNumber = _68 || 1;
                    _5f.pageSize = _69;
                    _66.pagination("refresh", {
                        pageNumber: _68,
                        pageSize: _69
                    });
                    load(_5d);
        ...
        _7d.each(function() {
            $(this).resizable({
                ...
                onStartResize: function(e) {
                    ...
                    _79.proxy.css({
                        left: e.pageX - $(_7a).offset().left - 1,
                        display: "none"
                    });
                    setTimeout(function() {
                        if (_79.proxy) {
    ...
    function _a6(_a7, _a8) {
        ...
        _a8 = _a8 || {};
        var _ab = {
            sortName: _aa.sortName,
            sortOrder: _aa.sortOrder
        };
    ...
    function _75(_eb, _ec) {
        ...
        var _ee = (_ec == true) ? (_ed.frozenColumns || [
            []
        ]) : _ed.columns;
        if (_ee.length == 0) {
            return [];
            ...
            if (col && col.editor) {
                ...
                if (_15f) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _15f,
                        target: _15f.init(cell.find("td"), _15e),
                        field: _15c,
                        type: _15d,
                        oldHtml: _160
                    });
    ...
    function deleteRow(grid, _16f) {
        ...
        $(_16e).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    function _173(_174, _175) {
        ...
        _176.push(_175.row);
        $(_174).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    function _177(_178, row) {
        ...
        _179.push(row);
        $(_178).datagrid("getPager").pagination("refresh", {
            total: data.total
        });
    };
    ...
    var _1a9 = $.extend({}, _19b(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.methods = {
        options: function(jq) {
            ...
            var opts = $.extend(_1c2, {
                width: _1c3.width,
                height: _1c3.height,
                closed: _1c3.closed,
                collapsed: _1c3.collapsed,
                minimized: _1c3.minimized,
                maximized: _1c3.maximized
            });
            return opts;
        },
    ...
    $.fn.datagrid.parseOptions = function(_1f1) {
        var t = $(_1f1);
        return $.extend({}, $.fn.panel.parseOptions(_1f1), $.parser.parseOptions(_1f1, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        editors: _1a9,
        finder: {
            getTr: function(_242, _243, type, _244) {
                type = type || "body";
                _244 = _244 || 0;
